...
class ActionViewHelperTest extends FunctionalTestCase
{
    ...
    public function itRendersAbsoluteLink ()
    {
        ...
        * Then no cHash is used
        ...
        self::assertStringContainsString('http://www.example.com/coreextended/mediasources', $result);
    ...
    public function itRendersAbsoluteLinkToGivenPage ()
    {
        ...
        $result = $this->standAloneViewHelper->render();
        self::assertStringContainsString('http://www.example.com/test/coreextended/mediasources', $result);
        self::assertStringNotContainsString('cHash=', $result);
    }
    ...
    public function itRendersAbsoluteLinkWithPageType ()
    {
        ...
        $result = $this->standAloneViewHelper->render();
        self::assertStringContainsString('http://www.example.com/coreextended/mediasources/print', $result);
        self::assertStringNotContainsString('cHash=', $result);
    }
